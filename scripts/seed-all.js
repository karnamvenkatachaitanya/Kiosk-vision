...
// Run with: mongosh mongodb://localhost:27017 --file scripts/seed-all.js
// ═══════════════════════════════════════
...
// ── 1. Seed categories ──
print("");
print("▸ [1/3] Seeding categories...");

db = db.getSiblingDB("kiosk_inventory");
db.categories.deleteMany({});
db.categories.insertMany([
  { _id: "grains",        name: "Grains and Cereals",    parent_id: null, icon: "wheat",    sort_order: 1, is_active: true, created_at: new Date() },
  { _id: "pulses",        name: "Pulses and Lentils",    parent_id: null, icon: "beans",    sort_order: 2, is_active: true, created_at: new Date() },
  { _id: "oils",          name: "Oils and Ghee",          parent_id: null, icon: "oil",      sort_order: 3, is_active: true, created_at: new Date() },
  ...
  { _id: "cleaning",      name: "Cleaning and Household", parent_id: null, icon: "broom",    sort_order: 10, is_active: true, created_at: new Date() },
]);
print("  done: 10 categories");

// ── 2. Seed products ──
print("");
print("▸ [2/3] Seeding products...");
...
db = db.getSiblingDB("kiosk_inventory");
db.products.createIndex({ name: "text", category: "text", description: "text" });
